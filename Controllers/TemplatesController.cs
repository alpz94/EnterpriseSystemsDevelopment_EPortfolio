...
namespace EnterpriseSystemsDevelopment_EPortfolio.Controllers
{
    public class TemplatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TemplateId,Name,Evidence")] Template template)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TemplateId,Name,Evidence")] Template template)
        {
